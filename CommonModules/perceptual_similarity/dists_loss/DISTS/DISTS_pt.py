...
class DISTS(torch.nn.Module):
    def __init__(self, load_weights=True):
        ...
        if load_weights:
            weights = torch.load(os.path.join(sys.prefix,'/media/D/wangjun/DEEPJSCC/DISTS/weights.pt'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ref', type=str, default='/media/D/wangjun/kodak1/kodim01.png')
    parser.add_argument('--dist', type=str, default='/media/D/wangjun/kodak1/test.png')
